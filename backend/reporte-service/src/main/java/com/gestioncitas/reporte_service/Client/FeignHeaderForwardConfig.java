 ...
 * entrante hacia las llamadas Feign salientes, para que doctor-service pueda autenticar
 * la llamada con su propio HeaderAuthFilter. Aplicado desde el inicio (lo aprendido en 4.4-4.6).
 */
@Configuration
